...
from .config import ConfigError, RuntimeConfig, load_manifest, resolve_raw_site_base_url
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "init":
            ...
            _emit({"status": "success", "manifest_cache": str(config.manifest_cache), "raw_site_base_url": base_url})
            return 0
